		...
		<div class="tab-content">				
			<div id="add-new-staff" class="tab-pane fade in active">					
				<div id="accordion" class="panel-group">						
					<div class="ct-staff-list col-md-3 col-sm-4 col-xs-12 col-lg-3">				<div class="ct-staff-container">								
					    ...
					    <ul class="nav nav-tab nav-stacked ct-left-staff" id="sortable">									
					    	...
					    	<li class="staff-list br-2 staff_click staff_<?php  echo $trigger;?> staff_c_<?php  echo $arr_staff['id'];?>" id="" data-id = "<?php echo $arr_staff['id'];?>">												<a href="" data-toggle="pill">											<span class="ct-staff-image"><img class="ct-staf-img-small 
			...
			<div class="panel-body pall-15">						
				...
				<div id="accordion" class="panel-group">							
					<div class="ct-calendar-top-bar">								
						<div class="col-md-4 col-sm-6 col-xs-12 col-lg-4 mb-10">					<label><?php echo $label_language_values['select_option_to_show_bookings']; ?></label>							<div id="reportrange" class="form-control" >								<i class="glyphicon glyphicon-calendar fa fa-calendar"></i>&nbsp;   	<span></span> <i class="fa fa-caret-down"></i>								
						    </div>								
						</div>																	
	...
	{											
		...
		for($i=0;$i<sizeof((array)$data_staff_pymnt_id);$i++)
		{
				...
				if($all['booking_status'] == 'A'){												
					...
					$status = 'Rejected';											
					}elseif($all['booking_status'] == 'CC'){												$status = 'Cancelled By Client';											
					}elseif($all['booking_status'] == 'CS'){												$status = 'Cancelled By Staff';											
					}elseif($all['booking_status'] == 'CO'){												$status = 'Completed';											
					}elseif($all['booking_status'] == 'MN'){												$status = 'Mark As No Show';											
					}elseif($all['booking_status'] == 'RS'){												$status = 'Rescheduled';											
					}										
				?>											
	<tr>												
		...
		<div class="modal-content">			
			...
			<div class="modal-body">				
				<form id="staff_insert" > 				
					<table class="form-horizontal" cellspacing="0" class="table-responsive">		<tbody>					
						...
						<tr class="form-field form-required">						
							<td><label for="staff_pass"><?php echo "Password";?> <span class="error">*</span></label></td>						
