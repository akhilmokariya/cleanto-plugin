...
//$frequently_discount = new to_frequently_discount();
...
if (isset($_SESSION['ct_login_user_id']))
{
    ...
    $details = $objuserdetails->get_user_details();
        ...
        <a target="_blank" href="<?php echo BASE_URL; ?>/assets/lib/download_invoice_client.php?iid=<?php echo $dd['order_id']; ?>" class="btn btn-primary"><i class="fa fa-download"></i><?php echo $label_language_values['download_invoice']; ?>
        </a>									
    ...
    { ?>                        
    	<div id="update-user-booking-details<?php echo $dd['order_id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">                            
    		<div class="vertical-alignment-helper">                                
    			<div class="modal-dialog modal-md vertical-align-center">                                    
    				...
    				<div class="modal-body">                                            
    					<div class="tab-content">                                                <div class="tab-pane fade in active">                                                    
    				<table>                                                        
    					<tbody>                                                        
    						<tr>                                                            
        ...
        $slot_counter = 0; ?>                                                                    <select class="selectpicker mydatepicker_appointment   form-control" id="myuser_reschedule_time" data-size="10" style="" >                                                                        <?php if ($time_schedule['off_day'] != true && isset($time_schedule['slots']) && sizeof((array)$time_schedule['slots']) > 0 && $allbreak_counter != sizeof((array)$time_schedule['slots']) && $allofftime_counter != sizeof((array)$time_schedule['slots']))
        {
