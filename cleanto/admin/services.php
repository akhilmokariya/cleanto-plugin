                     ...
                     <h4 class="panel-title">
                        <div class="cta-col7">
                          ...
                          <div class="cta-col6 cta-manage-price-addons">     
                           <a data-id="<?php echo $arr['id']; ?>" data-name="<?php echo $arr['title']; ?>" class=" manage-price-calculation-btn pull-left btn-circle btn-primary btn-sm mybtnforassignmethods" title="<?php echo $label_language_values['manage_price_calculation_methods']; ?>"> <i class="fa fa-calculator" title="<?php echo $label_language_values['manage_price_calculation_methods']; ?>"></i><?php echo $label_language_values['pricing']; ?></a>                                               
