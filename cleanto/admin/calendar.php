...
include(dirname(__FILE__).'/user_session_check.php');$setting = new 
cleanto_setting();
$setting->conn = $conn;
				...
				<div class="modal-dialog modal-md vertical-align-center">			
					<div class="modal-content">				
						...
						<div class="modal-body">					
							...
							<li style="width: 100%;">							
							    ...
							    <li><h6 class="ct-customer-details-hr">
							    	<?php  echo $label_language_values['customer'];?></h6>
							    </li>						
							    <li>							
							    ...
							    </li>						<li>							<label><?php  echo $label_language_values['company_address'];?></label>							
						...
						<div class="modal-footer">					
							<div class="col-xs-12 np ct-footer-popup-btn text-center">				<div class="fln-mrat-dib">							
								...
								<span class="col-xs-4 np ct-w-32 myconfirmclass">					<a id="ct-confirm-appointment" class="btn btn-link 
