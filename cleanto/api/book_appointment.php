...
if(isset($_POST["action"]) && $_POST["action"] == "book_appointment") {
	...
	verifyRequiredParams(array("api_key", "recurrence_id", "user_id", "staff_id", "payment_method", "sub_total", "tax", "discount", "freq_discount_amount", "net_amount", "order_duration"));
